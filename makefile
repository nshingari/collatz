...
FILES :=                              \
    ...
    TestCollatz.out                   \
    TestCollatz.py                    \
    cs330e-collatz-tests/nshingari-RunCollatz.in   \
    cs330e-collatz-tests/nshingari-RunCollatz.out  \
    cs330e-collatz-tests/nshingari-TestCollatz.out \
    cs330e-collatz-tests/nshingari-TestCollatz.py  \
